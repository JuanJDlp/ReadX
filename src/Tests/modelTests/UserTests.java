...
class UserTests {
    ...
    void validateCorrectAddingOfABook() {
        ...
        Assertions.assertTrue(user.getLibrary().amountOfProductsInAMatrix(0) == 1);
    ...
    void standarUserCanOnlyHaveFieBooks() {
        ...
        Assertions.assertTrue(user.getLibrary().amountOfProductsInAMatrix(0) == 5);
    }
    ...
    void standarUserCanOnlyHaveTwoMagazines() {
        ...
        Assertions.assertTrue(user.getLibrary().amountOfProductsInAMatrix(0) == 2);
    }
